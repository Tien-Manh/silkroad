...
@section('content')
    ...
    <div class="card my-4">
      ...
      <div class="card-body w-95 w-md-50 m-auto">
        ...
        @else
        @endif
        <form role="form" method="post" action="{{ route('create-save-edit') }}" class="text-start" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="id" value="{{ $storeImg->id }}">
          <div class="input-group input-group-outline mb-3 focused is-focused is-filled">
           ...
           <div class="input-group input-group-outline mb-3 focused is-focused">
            ...
            <select class="form-control" name="service">
              <option @if($storeImg->service == 1)selected @endif value="1">Enable</option>
              <option @if($storeImg->service == 0)selected @endif value="0">Disable</option>
            </select>
          </div>
